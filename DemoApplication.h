...
public:
	...
	//2013/09/12 add in mouseFunc used for leap control
	void testmouseFunc(int button, int state, int x, int y);
	//add in 2013/12/11 for displaying parameters in softbody
	void forceInsert(bool dw,bool sw,int sr,int fc,float ss);
