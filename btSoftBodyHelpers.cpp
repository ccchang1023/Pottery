										...
										int drawflags)
{
	...
	//const btVector3		lcolor = btVector3(201.0/255.0,119.0/255.0,43.0/255.0);
...
#define USE_NEW_CONVEX_HULL_COMPUTER
	...
	{
		const btScalar	scl=(btScalar)1.0;
		const btScalar	alp=(btScalar)1;
		//const btVector3	col((btScalar)153/255,(btScalar)102/255,(btScalar)51/255); 
		//const btVector3	col((btScalar)148/255,(btScalar)112/255,(btScalar)59/255);
		//const btVector3	col((btScalar)140/255,(btScalar)89/255,(btScalar)51/255);
		//const btVector3	col((btScalar)126/255,(btScalar)91/255,(btScalar)51/255);
		const btVector3	col((btScalar)133/255,(btScalar)90/255,(btScalar)61/255);
		//const btVector3	col((btScalar)133/255,(btScalar)87/255,(btScalar)44/255);
		...
		for(i=0;i<psb->m_faces.size();++i)
		{
			...
			const btVector3		normal[]={f.m_n[0]->m_n,f.m_n[1]->m_n,f.m_n[2]->m_n};
			//const btVector3		normal_adv[]={(normal[0]+normal[1])/2,(normal[0]+normal[2])/2,(normal[1]+normal[2])/2};
			const btVector3		centroid = (normal[0]+normal[1]+normal[2])/3;
			glBegin(GL_TRIANGLES);
			glNormal3f(f.m_normal.getX(),f.m_normal.getY(),f.m_normal.getZ());
			glNormal3f(centroid.getX(),centroid.getY(),centroid.getZ());
			glColor3f(col.getX(),col.getY(),col.getZ());
			for(int tk=0;tk<3;tk++){
				glNormal3f(normal[tk].getX(),normal[tk].getY(),normal[tk].getZ());
				glVertex3f(x[tk].getX(),x[tk].getY(),x[tk].getZ());
			}
			glEnd();
